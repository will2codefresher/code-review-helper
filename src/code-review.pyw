...
def prepare_review(option_handler, review_date, parent_frm):
    ...
    create_reviewed_history(option_handler, review_date, parent_frm)
...
def create_reviewed_history(option_handler, review_date, parent_frm):
    ...
    option_handler.grid(row=0, column=1)
...
if __name__ == '__main__':
    ...
    main_frm = Frame(top)
    main_frm_grid_col = 0
    Label(main_frm, text=r"Review History").grid(row=0, column=main_frm_grid_col)
    main_frm_grid_col += 1
    review_record_drop = OptionMenu(main_frm, review_date, *options or ' ')
    review_record_drop.grid(row=0, column=main_frm_grid_col)
    main_frm_grid_col += 1
    Label(main_frm, text=r"Code root path ").grid(row=0, column=main_frm_grid_col)
    main_frm_grid_col += 1
    Entry(main_frm, textvariable=repos_base_val).grid(row=0, column=main_frm_grid_col)
    main_frm_grid_col += 1
    Button(main_frm, text=u'..', command=select_base_dir).grid(row=0, column=main_frm_grid_col)
    main_frm_grid_col += 1
    Button(main_frm, text=u'Get Latest Code !',
        ...
        .grid(row=0, column=main_frm_grid_col)
    main_frm_grid_col += 1
    Button(main_frm, text=u'Create Review Baseline !',
           command=lambda option_handler=review_record_drop, review_date=review_date,
                          parent_frm=main_frm: create_reviewed_history(option_handler, review_date, parent_frm)) \
        .grid(row=0, column=main_frm_grid_col)
    main_frm_grid_col += 1
    main_frm.pack()
